...
export function getSharedActionViewClasses(primaryColor = `blue`) {
  // Define explicit color mappings to ensure Tailwind includes these classes
  const colorClasses = {
    blue: {
  ...
  return {
    ...
    label: `font-medium`,
    input: `border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 ${colors.ring} bg-gray-50`,
    categoryFilter: `flex gap-2 mb-4`,
    categoryButton: `px-3 py-1 rounded border transition-colors`,
    categoryButtonActive: `${colors.bgPrimary} text-white ${colors.borderPrimary}`,
    ...
    actionCost: `text-lg font-bold ${colors.textPrimary}`,
    ...
    customNameInput: `w-full px-3 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 ${colors.ring}`,
    addButton: `${colors.bgPrimary} text-white px-4 py-2 rounded ${colors.bgPrimaryHover} transition-colors`,
    addButtonDisabled: `bg-gray-300 text-gray-500 px-4 py-2 rounded cursor-not-allowed`,
    rules: `${colors.bgLight} border ${colors.borderLight} rounded-lg p-3 mb-4 text-sm ${colors.textLight}`,
    ...
    abilityCost: `text-lg font-bold ${colors.textPrimary}`,
    ...
    responseCost: `text-lg font-bold ${colors.textPrimary}`,
